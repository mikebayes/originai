...
export default function ServicesBuildPage() {
  return (
    <div className="bp-page">
      ...
      {/* WHAT WE BUILD — interactive left-nav + right-panel design.
          Replaces the v2 4-card grid 2026-05-06 per Mike's redesign.
          Logic lives in BuildDirections (client component). */}
      <section className="bp-work" data-screen-label="What we build — 4 directions">
        <div className="wrap">
