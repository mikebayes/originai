 ...
 *
 * Structural copy of components/Services.tsx (asymmetric featured-left
 * layout, aurora Build card with the review dashboard mock, mini roadmap
 * and sparkline on the supporting cards). Only copy changed.
 *
 * Copy decisions:
 *   - Section H2 no longer says "Working AI, owned end to end. Strategy,
 *     build, and operations." The who-we-are section above now covers
 *     the end-to-end claim, so this heading moves to the three lanes.
 *   - The section lede dropped "Three services from one senior team",
 *     which repeats the section above it.
 *   - Each card promise tightened to one sentence and reframed around
 *     what the client gets rather than what Origin is.
 */
        ...
        <header className="s-header" data-reveal>
          <div>
            ...
            <h2 className="s-h2 display">
              <span>Three ways we engage.</span>
              <span className="muted"> Separately, or in sequence.</span>
            </h2>
          </div>
          <p className="s-lede">
            Most clients start with one and add the others as the work
            develops. Each stands on its own.
          </p>
        </header>
        ...
        <div className="services-grid svc-grid-featured-left" data-reveal-stagger>
          ...
          <article className="svc svc-featured">
            ...
            <div className="svc-body">
              ...
              <p className="svc-promise">
                ...
                shaped to how your team actually works, instead of a SaaS stack
                you have to bend around.
              </p>
          ...
          <article className="svc svc-supporting">
            <div className="svc-body">
              ...
              <p className="svc-promise">
                Leadership sessions and AI training that clarify where AI fits,
                what standards matter, and which opportunities move first.
              </p>
          ...
          <article className="svc svc-supporting">
            <div className="svc-body">
              ...
              <p className="svc-promise">
                Ongoing improvement, user support, and backlog management for
                what is live, on a defined monthly scope.
              </p>
