...
/**
 * /services/managed — Managed AI Improvement.
 *
 * Promoted from /draft/services/managed. Replaces the previous live page,
 * which was rendered by components/ServicesManagedPage.tsx (now unused).
 *
 * SEO job: primary "managed AI services", secondary "AI workflow support",
 * "AI system support", "AI adoption support", "ongoing improvement".
 * The previous live title was just "Managed AI | Origin AI", the thinnest
 * on the site.
 *
 * Positioning: sits between advisory and delivery. Not an outsourced CAIO
 * retainer, not generic app maintenance. Section 3 keeps the explicit
 * boundary line and the FAQ keeps the "did not build the first system"
 * question.
 *
 * Sections: hero, launch is not the finish line, monthly rhythm,
 * monthly scope, what it can support, FAQ, CTA.
 */

export const metadata: Metadata = {
  title:
    "Managed AI Services | AI Workflow Support & Improvement | Origin AI",
  description:
    "Managed AI improvement for organizations that need support, refinement, and ongoing optimization after AI workflows, tools, or systems go live.",
...
const SERVICE_JSON_LD = {
  ...
  name: "Managed AI Improvement",
  description:
    "Managed AI services for organizations in Winnipeg and across Canada: ongoing improvement, user support, backlog management, and guidance for AI systems, workflows, and adoption efforts already underway.",
...
export default function ManagedAIImprovementPage() {
  return (
    <main>
      <script
      ...
      />
      {/* svc-dark + svc-dark--managed carry the dark hero treatment and
          this page's layout overrides. Shared with the other promoted
          service pages so the four stay visually consistent. */}
        ...
        <div className="bp-hero-shell">
          ...
          >
            ...
            <p className="bp-hero-sub">
              Origin provides managed AI services for organizations that need
              ongoing improvement, support, and guidance for AI systems,
              workflows, and adoption efforts as the business learns what
              works.
            </p>
