...
/**
 * /services/build — AI Workflow Development.
 *
 * Promoted from /draft/services/build. Replaces the previous live page,
 * which was rendered by components/ServicesBuildPage.tsx (now unused).
 *
 * SEO job: primary "custom AI software Winnipeg" and "AI workflow
 * development", secondary "custom AI software", "AI software development
 * Winnipeg", "internal AI tools", "AI assistants", "AI workflow
 * automation". "AI agents" is deliberately NOT targeted: high volume but
 * the wrong audience, and it was dropped from the title and the
 * organization schema in Phase 1.
 *
 * CAUTION for future edits: the homepage, not this page, is currently the
 * ranking URL for "custom AI software Winnipeg" (position 3). This page
 * averages position 36. The draft version of this page contained no
 * "AI software development" and no "Winnipeg" at all, so both were added
 * back in visible copy before promotion. Do not remove them without
 * checking GSC first.
 *
 * Sections: hero, where build starts, the work we can help improve,
 * what the solution can become, from idea to launch (+ workflow
 * artifact), CTA.
 */
...
export const metadata: Metadata = {
  ...
  description:
    "Custom AI software and workflow development for organizations that need internal tools, assistants, automations, and systems built around real work.",
...
const SERVICE_JSON_LD = {
  ...
  description:
    "Custom AI software and AI workflow development for organizations in Winnipeg and across Canada: internal tools, assistants, automations, integrations, and systems built around how teams already work.",
...
export default function AIWorkflowDevelopmentPage() {
  return (
    <main>
      <script
          ...
          <div className="wrap">
            <div className="bp-work-head">
              ...
              <p className="section-lede lede">
                Origin builds custom AI software and workflow tools for
                organizations in Winnipeg and across Canada, designed around
                the way their teams already work. The strongest opportunities
                usually appear where work takes too much time, depends on too
                much coordination, or requires the same judgment over and
                over.
              </p>
            </div>
            ...
            <div className="bp-origin-grid">
              ...
              {/* Links out now that /services/ai-training is live. Was a plain
                  cell while that route did not exist. */}
              <a href="/services/ai-training" className="bp-origin-cell is-link">
          ...
          <div className="wrap">
            <div className="bp-forms-head">
              ...
              <p className="bp-forms-lede">
                ...
                the solution. Some need no new software at all; others call
                for full AI software development.
              </p>
            </div>
