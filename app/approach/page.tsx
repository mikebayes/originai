...
/**
 * /approach — Origin's approach to AI adoption.
 *
 * Promoted from /draft/approach. Replaces the previous live page, which
 * was rendered by components/ApproachPage.tsx (now unused).
 *
 * SEO job: support page, not a primary acquisition page. Supports
 * "AI adoption process", "AI implementation approach", "AI consulting
 * process". Deliberately not over-optimized: the old page earned 1 click
 * on 597 impressions at position 23, so its real value is explaining the
 * operating model and handing off cleanly to the four service pages.
 *
 * Reflects the current four-service model throughout. The handoff rail in
 * the final body section links all four:
 *   Leadership AI Enablement -> /services/strategy
 *   Team AI Training         -> /services/ai-training
...
export const metadata: Metadata = {
  title:
    "Our AI Adoption Approach | Strategy, Training, Build & Improvement | Origin AI",
  description:
    "See how Origin AI helps organizations move from leadership direction to team training, workflow development, launch, and ongoing improvement.",
